...
r\left(\boldsymbol{\hat{\bar{\sigma}}}\right)\frac{\sigma_t\left(\boldsymbol{\bar{\epsilon}_{t}^{pl}}\right)}{g_t} & 0 & 0\\
0 & 0 & -\left(r\left(\boldsymbol{\hat{\bar{\sigma}}}\right)-1\right)\frac{\sigma_c\left(\boldsymbol{\bar{\epsilon}_{c}^{pl}}\right)}{g_c}
...
In addition, $g_t$ and $g_c$ represent the dissipated fracture energy density during micro-cracking. Furthermore, the weighting function, $r\left(\hat{\boldsymbol{\bar{\sigma}}}\right)$, weights the hardening functions depending on the degree of tension or compression that the model is experiencing:
