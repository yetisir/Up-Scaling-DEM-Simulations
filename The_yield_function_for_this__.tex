...
The hardening rule for this model is slightly modified from equation \ref{eqn:const8d} to accomodate two hardening variables for tension and compression. The hardening rule can thus be written in matrix form:

\begin{equation}
\mathbf{h}\left(\boldsymbol{\bar{\sigma}},\boldsymbol{\bar{\epsilon}^{pl}}\right)=\left[\begin{array}{ccc}
r\left(\boldsymbol{\hat{\bar{\sigma}}}\right)\frac{\sigma^y_t}{g_t} & 0 & 0\\
0 & 0 & -\left(r\left(\boldsymbol{\hat{\bar{\sigma}}}\right)-1\right)\frac{\sigma^y_c}{g_c}
