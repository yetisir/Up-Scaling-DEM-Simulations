...
of the blocks that intersect the REV boundary, as illustrated in \ref{fig:homoarea}.
The homogenization domain is characterized byf a series of block corners
