...
In terms of a constitutive relationship relating the elastic strain, $\boldsymbol{\epsilon^{el}}$, to the Cauchy stress, $\boldsymbol{\sigma}$, one can modify the standard elastic constitutive relationship to include a scalar damage
