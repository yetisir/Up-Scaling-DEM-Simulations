...
Such that the damage variable is acting a scaling factor for the elastic stiffness, $\mathbf{E}$. For simplicity, the damaged elastic stiffness is described as the
