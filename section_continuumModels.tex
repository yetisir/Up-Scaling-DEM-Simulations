...
Such that the damage variable can be considered as acting a scaling factor for the elastic stiffness tensor, $\mathbf{E}$. From equations \ref{eqn:const3a} and \ref{eqn:const3}, it follows that the damaged elastic stiffness, $\mathbf{E^{d}}$, can be described as the degraded stiffness due to the damage: 
\begin{equation}
