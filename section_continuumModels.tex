...
Using the principles of CDM, one can modify the standard elastic constitutive relationship to include a scalar damage parameter, $\mathbf{D}$, which helps relate the Cauchy stress, $\boldsymbol{\sigma}$, to the elastic strain, $\boldsymbol{\epsilon^{el}}$ and can be written as follows: 
\begin{equation}
