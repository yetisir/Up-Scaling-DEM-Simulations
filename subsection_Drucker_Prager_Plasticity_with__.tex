...
In addition, the damage evolution was parameterized using only the plastic displacement at failure parameter.
...
\multirow{4}{*}{Damage}  & \multirow{3}{*}{Initiation}     & Yeild Strain at 0 Triaxiality      & $\frac{\bar{\epsilon}^{pl}_{f_{0}}$   \\
                         &                                 & Yeild Strain at 1 Triaxiality      & $\frac{\bar{\epsilon}^{pl}_{f_{1}}$   \\
                         &                                 & Yeild Strain at 0.5 Triaxiality    & $\frac{\bar{\epsilon}^{pl}_{f_{0.5}}$ \\ \cmidrule(lr){2-2}
