...
\multirow{7}{*}{Plastic} & \multirow{4}{*}{\begin{tabular}[c]{@{}c@{}}Flow Rule / \\ Yield Function\end{tabular}} & Dilation Angle                     & $\psi$                                  \\
                         &                                                                                        & Yield Stress Ratio                 & $K$                                     \\
                         &                                                                                        & Friction Angle                     & $\beta$                                 \\
                         &                                                                                        & Initial Tensile Strength           & $p_0^t$                                 \\ \cline{2-2}
...
\multirow{3}{*}{Damage}  & \multirow{2}{*}{Initiation}                                                            & Yeild Strain at -0.5 Triaxiality   & $\frac{\bar{\epsilon}^{pl}_{f_{-0.5}}$  \\
                         &                                                                                        & Yeild Strain at -0.75 Triaxiality  & $\frac{\bar{\epsilon}^{pl}_{f_{-0.75}}$ \\
