...
\begin{equation}
d\boldsymbol{\epsilon_p}=d\lambda \frac{\partial G(\bar{\boldsymbol{\sigma}})}{\partial \boldsymbol{\sigma}}
\label{eqn:const8b}
\end{equation}

Where $\epsilon_p$ is the plastic strain, $\lambda$ is a hardening parameter, and $G(\bar{\boldsymbol{\sigma}}$ is the flow potential function. In both models presented here, the flow potential function is taken from the Drucker-Prager model:
