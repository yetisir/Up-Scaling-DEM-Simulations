...
\begin{equation}
G\left(\sigma_{ij}\right)=\sqrt{\left[\varepsilon\sigma^{iy}\tan\left(\psi\right)\right]^{2}+q\left(\sigma_{ij}\right)^{2}}-p\left(\sigma_{ij}\right)\tan\left(\psi\right)\label{eqn:const11}
\end{equation}
...
p\left(\sigma_{ij}\right)=frac{1}{3}\sigma_kk
\label{eqn:druc3}
\end{equation}

\begin{equation}
%\sqrt{\frac{3}{2}}\left(\mathbf{S}:\mathbf{S}\right)
q\left(\sigma_{ij}\right)=\sqrt{frac{3}{2}S_{ij}S_{ij}}\label{eqn:druc4}
\end{equation}
...
S_{ij} = \sigma_ij + p\left(\sigma_{ij}\right)\delta_{ij}
\end{equation}
